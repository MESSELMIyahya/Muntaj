...
export default function ProductCard({
  ...
  return (
    <div className="p-4 rounded-xl bg-card duration-300 hover:duration-300 transition-colors hover:transition-colors hover:bg-accent hover:shadow-sm border mb-6">
      ...
      <div className="w-full">
        <div className="w-full flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant="outline"
              className="flex text-sm items-center gap-1 rounded-sm"
            >
        ...
        <p className="text-sm line-clamp-4 text-muted-foreground mb-2">
          {description}
        </p>
      </div>
